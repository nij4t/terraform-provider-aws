...
import (
	...
	"github.com/nij4t/terraform-provider-aws/internal/service/accessanalyzer"
	"github.com/nij4t/terraform-provider-aws/internal/service/account"
	"github.com/nij4t/terraform-provider-aws/internal/service/acm"
	"github.com/nij4t/terraform-provider-aws/internal/service/acmpca"
	"github.com/nij4t/terraform-provider-aws/internal/service/amp"
	"github.com/nij4t/terraform-provider-aws/internal/service/amplify"
	"github.com/nij4t/terraform-provider-aws/internal/service/apigateway"
	"github.com/nij4t/terraform-provider-aws/internal/service/apigatewayv2"
	"github.com/nij4t/terraform-provider-aws/internal/service/appautoscaling"
	"github.com/nij4t/terraform-provider-aws/internal/service/appconfig"
	"github.com/nij4t/terraform-provider-aws/internal/service/appmesh"
	"github.com/nij4t/terraform-provider-aws/internal/service/apprunner"
	"github.com/nij4t/terraform-provider-aws/internal/service/appstream"
	"github.com/nij4t/terraform-provider-aws/internal/service/appsync"
	"github.com/nij4t/terraform-provider-aws/internal/service/athena"
	"github.com/nij4t/terraform-provider-aws/internal/service/autoscaling"
	"github.com/nij4t/terraform-provider-aws/internal/service/autoscalingplans"
	"github.com/nij4t/terraform-provider-aws/internal/service/backup"
	"github.com/nij4t/terraform-provider-aws/internal/service/batch"
	"github.com/nij4t/terraform-provider-aws/internal/service/budgets"
	"github.com/nij4t/terraform-provider-aws/internal/service/chime"
	"github.com/nij4t/terraform-provider-aws/internal/service/cloud9"
	"github.com/nij4t/terraform-provider-aws/internal/service/cloudcontrol"
	"github.com/nij4t/terraform-provider-aws/internal/service/cloudformation"
	"github.com/nij4t/terraform-provider-aws/internal/service/cloudfront"
	"github.com/nij4t/terraform-provider-aws/internal/service/cloudhsmv2"
	"github.com/nij4t/terraform-provider-aws/internal/service/cloudtrail"
	"github.com/nij4t/terraform-provider-aws/internal/service/cloudwatch"
	"github.com/nij4t/terraform-provider-aws/internal/service/cloudwatchlogs"
	"github.com/nij4t/terraform-provider-aws/internal/service/codeartifact"
	"github.com/nij4t/terraform-provider-aws/internal/service/codebuild"
	"github.com/nij4t/terraform-provider-aws/internal/service/codecommit"
	"github.com/nij4t/terraform-provider-aws/internal/service/codedeploy"
	"github.com/nij4t/terraform-provider-aws/internal/service/codepipeline"
	"github.com/nij4t/terraform-provider-aws/internal/service/codestarconnections"
	"github.com/nij4t/terraform-provider-aws/internal/service/codestarnotifications"
	"github.com/nij4t/terraform-provider-aws/internal/service/cognitoidentity"
	"github.com/nij4t/terraform-provider-aws/internal/service/cognitoidp"
	"github.com/nij4t/terraform-provider-aws/internal/service/configservice"
	"github.com/nij4t/terraform-provider-aws/internal/service/connect"
	"github.com/nij4t/terraform-provider-aws/internal/service/cur"
	"github.com/nij4t/terraform-provider-aws/internal/service/datapipeline"
	"github.com/nij4t/terraform-provider-aws/internal/service/datasync"
	"github.com/nij4t/terraform-provider-aws/internal/service/dax"
	"github.com/nij4t/terraform-provider-aws/internal/service/devicefarm"
	"github.com/nij4t/terraform-provider-aws/internal/service/directconnect"
	"github.com/nij4t/terraform-provider-aws/internal/service/dlm"
	"github.com/nij4t/terraform-provider-aws/internal/service/dms"
	"github.com/nij4t/terraform-provider-aws/internal/service/docdb"
	"github.com/nij4t/terraform-provider-aws/internal/service/ds"
	"github.com/nij4t/terraform-provider-aws/internal/service/dynamodb"
	"github.com/nij4t/terraform-provider-aws/internal/service/ec2"
	"github.com/nij4t/terraform-provider-aws/internal/service/ecr"
	"github.com/nij4t/terraform-provider-aws/internal/service/ecrpublic"
	"github.com/nij4t/terraform-provider-aws/internal/service/ecs"
	"github.com/nij4t/terraform-provider-aws/internal/service/efs"
	"github.com/nij4t/terraform-provider-aws/internal/service/eks"
	"github.com/nij4t/terraform-provider-aws/internal/service/elasticache"
	"github.com/nij4t/terraform-provider-aws/internal/service/elasticbeanstalk"
	"github.com/nij4t/terraform-provider-aws/internal/service/elasticsearch"
	"github.com/nij4t/terraform-provider-aws/internal/service/elastictranscoder"
	"github.com/nij4t/terraform-provider-aws/internal/service/elb"
	"github.com/nij4t/terraform-provider-aws/internal/service/elbv2"
	"github.com/nij4t/terraform-provider-aws/internal/service/emr"
	"github.com/nij4t/terraform-provider-aws/internal/service/events"
	"github.com/nij4t/terraform-provider-aws/internal/service/firehose"
	"github.com/nij4t/terraform-provider-aws/internal/service/fms"
	"github.com/nij4t/terraform-provider-aws/internal/service/fsx"
	"github.com/nij4t/terraform-provider-aws/internal/service/gamelift"
	"github.com/nij4t/terraform-provider-aws/internal/service/glacier"
	"github.com/nij4t/terraform-provider-aws/internal/service/globalaccelerator"
	"github.com/nij4t/terraform-provider-aws/internal/service/glue"
	"github.com/nij4t/terraform-provider-aws/internal/service/guardduty"
	"github.com/nij4t/terraform-provider-aws/internal/service/iam"
	"github.com/nij4t/terraform-provider-aws/internal/service/identitystore"
	"github.com/nij4t/terraform-provider-aws/internal/service/imagebuilder"
	"github.com/nij4t/terraform-provider-aws/internal/service/inspector"
	"github.com/nij4t/terraform-provider-aws/internal/service/iot"
	"github.com/nij4t/terraform-provider-aws/internal/service/kafka"
	"github.com/nij4t/terraform-provider-aws/internal/service/kinesis"
	"github.com/nij4t/terraform-provider-aws/internal/service/kinesisanalytics"
	"github.com/nij4t/terraform-provider-aws/internal/service/kinesisanalyticsv2"
	"github.com/nij4t/terraform-provider-aws/internal/service/kinesisvideo"
	"github.com/nij4t/terraform-provider-aws/internal/service/kms"
	"github.com/nij4t/terraform-provider-aws/internal/service/lakeformation"
	"github.com/nij4t/terraform-provider-aws/internal/service/lambda"
	"github.com/nij4t/terraform-provider-aws/internal/service/lexmodels"
	"github.com/nij4t/terraform-provider-aws/internal/service/licensemanager"
	"github.com/nij4t/terraform-provider-aws/internal/service/lightsail"
	"github.com/nij4t/terraform-provider-aws/internal/service/macie"
	"github.com/nij4t/terraform-provider-aws/internal/service/macie2"
	"github.com/nij4t/terraform-provider-aws/internal/service/mediaconvert"
	"github.com/nij4t/terraform-provider-aws/internal/service/mediapackage"
	"github.com/nij4t/terraform-provider-aws/internal/service/mediastore"
	"github.com/nij4t/terraform-provider-aws/internal/service/meta"
	"github.com/nij4t/terraform-provider-aws/internal/service/mq"
	"github.com/nij4t/terraform-provider-aws/internal/service/mwaa"
	"github.com/nij4t/terraform-provider-aws/internal/service/neptune"
	"github.com/nij4t/terraform-provider-aws/internal/service/networkfirewall"
	"github.com/nij4t/terraform-provider-aws/internal/service/opsworks"
	"github.com/nij4t/terraform-provider-aws/internal/service/organizations"
	"github.com/nij4t/terraform-provider-aws/internal/service/outposts"
	"github.com/nij4t/terraform-provider-aws/internal/service/pinpoint"
	"github.com/nij4t/terraform-provider-aws/internal/service/pricing"
	"github.com/nij4t/terraform-provider-aws/internal/service/qldb"
	"github.com/nij4t/terraform-provider-aws/internal/service/quicksight"
	"github.com/nij4t/terraform-provider-aws/internal/service/ram"
	"github.com/nij4t/terraform-provider-aws/internal/service/rds"
	"github.com/nij4t/terraform-provider-aws/internal/service/redshift"
	"github.com/nij4t/terraform-provider-aws/internal/service/resourcegroups"
	"github.com/nij4t/terraform-provider-aws/internal/service/resourcegroupstaggingapi"
	"github.com/nij4t/terraform-provider-aws/internal/service/route53"
	"github.com/nij4t/terraform-provider-aws/internal/service/route53recoverycontrolconfig"
	"github.com/nij4t/terraform-provider-aws/internal/service/route53recoveryreadiness"
	"github.com/nij4t/terraform-provider-aws/internal/service/route53resolver"
	"github.com/nij4t/terraform-provider-aws/internal/service/s3"
	"github.com/nij4t/terraform-provider-aws/internal/service/s3control"
	"github.com/nij4t/terraform-provider-aws/internal/service/s3outposts"
	"github.com/nij4t/terraform-provider-aws/internal/service/sagemaker"
	"github.com/nij4t/terraform-provider-aws/internal/service/schemas"
	"github.com/nij4t/terraform-provider-aws/internal/service/secretsmanager"
	"github.com/nij4t/terraform-provider-aws/internal/service/securityhub"
	"github.com/nij4t/terraform-provider-aws/internal/service/serverlessrepo"
	"github.com/nij4t/terraform-provider-aws/internal/service/servicecatalog"
	"github.com/nij4t/terraform-provider-aws/internal/service/servicediscovery"
	"github.com/nij4t/terraform-provider-aws/internal/service/servicequotas"
	"github.com/nij4t/terraform-provider-aws/internal/service/ses"
	"github.com/nij4t/terraform-provider-aws/internal/service/sfn"
	"github.com/nij4t/terraform-provider-aws/internal/service/shield"
	"github.com/nij4t/terraform-provider-aws/internal/service/signer"
	"github.com/nij4t/terraform-provider-aws/internal/service/simpledb"
	"github.com/nij4t/terraform-provider-aws/internal/service/sns"
	"github.com/nij4t/terraform-provider-aws/internal/service/sqs"
	"github.com/nij4t/terraform-provider-aws/internal/service/ssm"
	"github.com/nij4t/terraform-provider-aws/internal/service/ssoadmin"
	"github.com/nij4t/terraform-provider-aws/internal/service/storagegateway"
	"github.com/nij4t/terraform-provider-aws/internal/service/sts"
	"github.com/nij4t/terraform-provider-aws/internal/service/swf"
	"github.com/nij4t/terraform-provider-aws/internal/service/synthetics"
	"github.com/nij4t/terraform-provider-aws/internal/service/timestreamwrite"
	"github.com/nij4t/terraform-provider-aws/internal/service/transfer"
	"github.com/nij4t/terraform-provider-aws/internal/service/waf"
	"github.com/nij4t/terraform-provider-aws/internal/service/wafregional"
	"github.com/nij4t/terraform-provider-aws/internal/service/wafv2"
	"github.com/nij4t/terraform-provider-aws/internal/service/worklink"
	"github.com/nij4t/terraform-provider-aws/internal/service/workspaces"
	"github.com/nij4t/terraform-provider-aws/internal/service/xray"
